...
use Calculadora\catalogoBundle\Entity\Producto;
use Calculadora\catalogoBundle\Form\ProductoType;
...
class ProductoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CalculadoracatalogoBundle:Producto')->findAll();
     ...
     * @Method("POST")
     * @Template("CalculadoracatalogoBundle:Producto:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CalculadoracatalogoBundle:Producto')->find($id);
     ...
     * @Method("PUT")
     * @Template("CalculadoracatalogoBundle:Producto:edit.html.twig")
     */
