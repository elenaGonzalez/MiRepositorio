...
use Calculadora\catalogoBundle\Entity\Marca;
use Calculadora\catalogoBundle\Form\MarcaType;
...
class MarcaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CalculadoracatalogoBundle:Marca')->findAll();
     ...
     * @Method("POST")
     * @Template("CalculadoracatalogoBundle:Marca:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CalculadoracatalogoBundle:Marca')->find($id);
     ...
     * @Method("PUT")
     * @Template("CalculadoracatalogoBundle:Marca:edit.html.twig")
     */
